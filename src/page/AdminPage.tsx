      ...
      <div className="min-h-screen bg-[#F8F9FA] mt-[50px] flex font-sans text-[#1A1A1A]">
            ...
            <>
              ...
              >
                ...
                <nav className="flex-1 p-4 space-y-2">
                  <a className="flex items-center gap-3 p-3 rounded-lg bg-[#EFF6FF] text-[#2563EB]">
                    <Clock size={20} /> Requests
                  </a>
                  <a className="flex items-center gap-3 p-3 text-[#6B7280]">
                    <Users size={20} /> Users
                  </a>
                  <a className="flex items-center gap-3 p-3 text-[#6B7280]">
        ...
        <aside className="hidden md:flex w-64 bg-white border-r border-[#E5E7EB] flex-col">
          ...
          <nav className="flex-1 p-4 space-y-2">
            <a
              href="#"
              className="flex items-center gap-3 p-3 rounded-lg bg-[#EFF6FF] text-[#2563EB] font-medium"
            >
              <Clock size={20} />
              <span>Requests</span>
            </a>
            <a
              href="#"
              className="flex items-center gap-3 p-3 rounded-lg text-[#6B7280] hover:bg-[#F3F4F6] transition-colors"
            >
              <Users size={20} />
              <span>Users</span>
            </a>
